...
struct ScheduleSelectionViewFactoryImpl: ScheduleSelectionViewFactory {
    ...
    public func createView() -> any View {
        ScheduleSelectionView(viewModel: ScheduleSelectionViewModelImpl(movieRepository: DependenciesManager.getter!(), userScheduleRepository: DependenciesManager.getter!(), theaterRepository: DependenciesManager.getter!()))
    }
}
